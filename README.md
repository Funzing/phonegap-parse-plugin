...
```
phonegap local plugin add https://github.com/Funzing/phonegap-parse-plugin.git --variable APP_ID=PARSE_APP_ID --variable CLIENT_KEY=PARSE_CLIENT_KEY
cordova plugin add https://github.com/Funzing/phonegap-parse-plugin.git --variable APP_ID=PARSE_APP_ID --variable CLIENT_KEY=PARSE_CLIENT_KEY
```
